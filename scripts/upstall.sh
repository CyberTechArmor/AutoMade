...
create_docker_compose() {
    ...
    cat > "$INSTALL_DIR/docker-compose.prod.yml" <<'EOFYAML'
...
EOFYAML
    ...
    # Add data directory path (requires variable expansion)
    echo "      - ${DATA_DIR}:/data/automade" >> "$INSTALL_DIR/docker-compose.prod.yml"
...
EOFYAML
    ...
    echo "      - ${DATA_DIR}/postgres:/var/lib/postgresql/data" >> "$INSTALL_DIR/docker-compose.prod.yml"
...
EOFYAML
    ...
    echo "      - ${DATA_DIR}/redis:/data" >> "$INSTALL_DIR/docker-compose.prod.yml"
