...
const STAGES: ProjectStage[] = ['discovery', 'design', 'development', 'deployment', 'operation', 'completed', 'on_hold'];
      ...
      <div className="space-y-6">
        ...
        <div className="card">
          ...
          <div className="flex items-center gap-2">
            {STAGES.filter(s => s !== 'on_hold').map((stage, index) => (
            ...
            <div className="ml-auto">
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium ${
                  project.stage === 'on_hold' ? STAGE_COLORS.on_hold : 'bg-gray-100 text-gray-500 hover:bg-red-50 hover:text-red-700'
                }`}
              >
                On Hold
              </button>
